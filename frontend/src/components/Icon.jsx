const icons = {
  ...
  skill: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2 15 9 22 9.3 16.5 14 18 21 12 17.3 6 21 7.5 14 2 9.3 9 9Z" />
    </svg>
  ),
  milestone: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M6 9V2h12v7" />
      <path d="M6 22v-7h12v7" />
      <path d="M2 9h20" />
      <path d="M2 15h20" />
    </svg>
  ),
...
export default function Icon({ name, size = 20 }) {
  return <span className="icon" style={{ width: size, height: size, display: "inline-flex" }}>{icons[name]}</span>;
}
